...
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 95 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 97 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
...
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 7 ->
    yystate(4, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 95 ->
    yystate(6, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(1, [9|Ics], Line, Tlen, _, _) ->
    yystate(1, Ics, Line, Tlen+1, 1, Tlen);
yystate(1, [8|Ics], Line, Tlen, _, _) ->
    yystate(6, Ics, Line, Tlen+1, 1, Tlen);
yystate(1, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 7 ->
    yystate(1, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(0, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 7 ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
yystate(0, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 95 ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
yystate(0, [C|Ics], Line, Tlen, Action, Alen) when C >= 97 ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
...
yyaction_1(TokenChars, TokenLine) ->
     { token, { literal, TokenLine, string : strip (TokenChars, both, 96) } } .
