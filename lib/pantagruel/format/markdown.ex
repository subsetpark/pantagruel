defmodule Pantagruel.Format.Markdown do
  @moduledoc """
  Takes an evaluated Pantagruel program and generates a formatted text
  representation of it.
  """
  @behaviour Pantagruel.Format.Formatter
  ...
  """
  @spec format_exp(any, [%{}]) :: Format.Formatter.t()
  ...
  @spec format_lambda(nil | Keyword.t() | map, keyword) :: Format.Formatter.t()
  defp format_lambda(
