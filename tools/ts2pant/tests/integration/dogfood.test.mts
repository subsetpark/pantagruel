...
describe("dogfood: @pant annotations entail", () => {
  ...
  const annotated: Array<{ file: string; fn: string; minChecks: number }> = [
    ...
    {
      file: "annotations.ts",
      fn: "extractFunctionAnnotations",
      minChecks: 1,
    },
    { file: "ir1-build.ts", fn: "isCommutativeBinop", minChecks: 1 },
    { file: "ir1-build.ts", fn: "isLengthCardinalityType", minChecks: 1 },
    { file: "ir1-build.ts", fn: "isSizeCardinalityType", minChecks: 1 },
    {
      file: "ir1-ssa-counter-loop.ts",
      fn: "isAccumulatorOuterOp",
      minChecks: 1,
    },
    {
      file: "ir1-ssa-counter-loop.ts",
      fn: "recurrenceUnsupported",
      minChecks: 1,
    },
    {
      file: "ir1-ssa-counter-loop.ts",
      fn: "isCounterBoundCmpOp",
      minChecks: 1,
    },
    { file: "ir1-ssa-scalars.ts", fn: "scalarPropertyKey", minChecks: 1 },
    { file: "ir1-ssa-scalars.ts", fn: "scalarLocalBindingKey", minChecks: 1 },
    { file: "nullish-recognizer.ts", fn: "isNullishSentinel", minChecks: 1 },
    { file: "translate-body.ts", fn: "mapWriteKey", minChecks: 1 },
